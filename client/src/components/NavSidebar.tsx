...
const NAV_ITEMS: { path: string; label: string; icon: React.ReactNode }[] = [
  ...
  { path: '/testing', label: '测试与缺陷', icon: <FlaskConical size={ICON_SIZE} /> },
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
        <button
          ...
          style={{
            ...
            background: location.pathname === '/assistant' ? 'rgba(0,168,168,0.1)' : 'transparent',
            color: location.pathname === '/assistant' ? 'var(--accent-blue)' : 'var(--text-tertiary)',
